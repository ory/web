...
const IndexPage = () => (
  ...
  <Quickstart
      ...
      description={
        <>
          ...
          <br />Make yourself heard in discussions and contribute directly to Ory on GitHub. 
          <br />Your code will be shipped in the next version.
      ...
      content={[
        ...
        {
          icon: <Users size={32} />,
          title: <>GitHub:<br /> Discussions & Code</>,
          description: (
            <>
              Make yourself heard on GitHub and contribute code and insights to the open source projects at
              the heart of Ory.
            </>
          ),
          button: (
    ...
    <FeatureImage
      ...
      description={
        <>
          Grow your users, easily register and manage user identities, using custom flows in your look and feel.
        </>
      }      
      buttons={
        <>
          <Button to={'docs/kratos/next/'} 
          style={'link'}
          iconRight={<ArrowRight size={16} />}
          >
          Install Kratos
    ...
    <FeatureImage
      ...
      description={
        <>
          Keep threats out and easily verify who is a user and customize sign in flows that fit you and your users.
        </>
      }
      buttons={
        <>
          <Button to={'docs/hydra/next/'} 
          style={'link'}
          iconRight={<ArrowRight size={16} />}
          >
          Install Hydra
  ...
  description={
    <>
      Be in full control - secure webfacing applications and services by implementing Zero Trust Network Architecture.
    </>
  }      
  buttons={
    <>
      <Button to={'docs/oathkeeper/next/'} 
      style={'link'}
      iconRight={<ArrowRight size={16} />}
      >
