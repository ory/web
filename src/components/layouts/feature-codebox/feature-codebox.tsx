...
import { featureCodebox } from './feature-codebox.module.css'
...
const FeatureCodebox = ({
  ...
  return (
    <div className={cn(featureCodebox)}>
      <Container
        fluid={true}
